...
import com.hotel.lodgingCommander.model.user.CustomOAuth2User;
import com.hotel.lodgingCommander.model.user.NaverResponse;
import com.hotel.lodgingCommander.model.user.OAuth2Response;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (existData == null) {
            ...
            user.setGrade(UserGrade.SILVER);
            ...
            userModelDTO.setGrade(UserGrade.SILVER);
            ...
            userModel.setGrade(existData.getGrade());
