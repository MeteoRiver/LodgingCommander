...
public class QRoom extends EntityPathBase<Room> {
    ...
    private static final long serialVersionUID = 745771894L;
    ...
    public QRoom(Class<? extends Room> type, PathMetadata metadata, PathInits inits) {
        ...
        this.img = inits.isInitialized("img") ? new QImg(forProperty("img"), inits.get("img")) : null;
    }
